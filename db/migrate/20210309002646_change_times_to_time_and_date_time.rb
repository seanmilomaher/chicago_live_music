class ChangeTimesToTimeAndDateTime < ActiveRecord::Migration[6.0]
  def change
    ...
    change_column :events, :start_date_time, 'datetime USING CAST(start_date_time AS datetime)'
    change_column :events, :end_date_time, 'datetime USING CAST(end_date_time AS datetime)'
